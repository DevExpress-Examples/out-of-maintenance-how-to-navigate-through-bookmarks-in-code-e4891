...
'			Me.barButtonItemNext.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItemNext_ItemClick);
			' 
			' barButtonItemPrev
			' 
...
'			Me.barButtonItemPrev.ItemClick += New DevExpress.XtraBars.ItemClickEventHandler(Me.barButtonItemPrev_ItemClick);
			' 
			' fileRibbonPage1
			' 
